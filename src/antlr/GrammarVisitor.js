...
export default class GrammarVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by GrammarParser#subroutines.
	visitSubroutines(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by GrammarParser#playStatement.
	visitPlayStatement(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by GrammarParser#drawtextStatement.
	...
	// Visit a parse tree produced by GrammarParser#drawclearareaStatement.
	...
	// Visit a parse tree produced by GrammarParser#arrayIdList.
	...
	// Visit a parse tree produced by GrammarParser#opModExp.
	visitOpModExp(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by GrammarParser#atomModExp.
	visitAtomModExp(ctx) {
	  return this.visitChildren(ctx);
	}
